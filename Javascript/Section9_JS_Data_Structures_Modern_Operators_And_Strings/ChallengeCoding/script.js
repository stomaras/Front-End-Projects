/* 
We 're building a football betting app (soccer for my american's friends)

Suppose we get data from a web service about a certain game (below). In this challenge we are gonna work with the data.
So here are your tasks.

1. Create one player array for each team (variables 'players1' and 'players2')
2. The first player in any player array is the goalkeeper and others are field players.For Bayern Munich (team 1) create one variable ('gk')
with the goalkeepe's name, and one array ('fieldPlayers') with all the remaining 10 field players
...
plus 'Thiago', 'Coutihno' and 'Perisic'
5. Based on the game.odds object, create one variable for each odd (called 'team1', 'draw' and 'team2')
6. Write a function ('printGoals') that receives an arbitrary number of players names (NOT an array) and prints each of them to the console, along with the 
...
// Coding Challenge Sets Maps Arrays Objects 
/* 
...
themselves, and the keys are the minutes in which each event happened ( a football game has 90 minutes plus some extras time).
