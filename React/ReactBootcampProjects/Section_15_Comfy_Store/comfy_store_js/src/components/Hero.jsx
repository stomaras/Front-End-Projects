  ...
  return (
    <div className='grid lg:grid-cols-2 gap-24 item-center'>
        <div>
            ...
            <p className='mt-8 max-w-xl text-lg leading-8'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur, officiis.</p>
            <div className='mt-10'>
        ...
        <div className='hidden h-[28rem] lg:carousel carousel-center p-4 space-x-4 bg-neutral rounded-box'>
            {carouselImages.map((image) => {
                return <div key={image} className='carousel-item'>
                    <img src={image} alt="rounded-box h-full w-80 object-cover"/>
                </div>
            })}
        </div>
    </div>
